                        ...
                        child: Center(
                          child: Column(
                            ...
                            children: [
                              ...
                              const Text('No known people yet',
                                  style: TextStyle(
                                      fontSize: 18,
                                      fontWeight: FontWeight.bold)),
                              const SizedBox(height: 8),
                              const Text(
                                  'Add a caregiver contact and scan their face to recognize them easily.',
                              ...
                              ElevatedButton.icon(
                                onPressed: () async {
                                  final refresh =
                                    ...
                                    MaterialPageRoute(
                                      builder: (_) => KnownPersonDetailScreen(
                      ...
                      Expanded(
                        child: ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            final person =
                                _knownPeople[index] as Map<String, dynamic>;
                            final name = person['name'] as String? ?? 'Unknown';
                            final relationship =
                                person['relationship'] as String? ?? '';
                            final initials = name
                                .split(RegExp(r"\s+"))
